...
const Registration = () => {
  ...
  const usernameHandler = (e) => {
    ...
    if (e.target.value.length < 3 || e.target.value.length > 12) {
      setUsernameError(
        "Имя пользователя должно быть длиннее 3 и меньше 20 символов"
      );
      if (!e.target.value) {
      ...
      <form className={styles.form} onSubmit={(e) => SignUp(e)}>
        ...
        <div className={styles.form__row}>
          ...
          <input
            ...
            id="username"
            placeholder=" "
            className={styles.form__row_input}
            autoComplete="off"
          />
          <label htmlFor="username" className={styles.form__row_label}>
            Username
          </label>
        </div>
        <div className={styles.form__row}>
          ...
          <input
            ...
            autoComplete="off"
          />
          <label htmlFor="password" className={styles.form__row_label}>
            Password
          </label>
        </div>
        <div className={styles.form__row}>
          ...
          <input
            ...
            autoComplete="off"
          />
          <label htmlFor="email" className={styles.form__row_label}>
            Email
          </label>
        </div>
        <button disabled={!formValid} className={styles.form__btn}>
          Submit
        </button>
      </form>
    </>
